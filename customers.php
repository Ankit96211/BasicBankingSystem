                ...
                <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="container">
                        <div class="row row-header justify-content-center">
                            ...
                            <div class="col-12">
                                 <h1 class="text-center poppins font-weight-bold mb-2">Please <span class="text-yellow">Select</span> a customer to send Money</h1>
                              <table class="table table-striped table-light table-hover">
  <thead class="thead-dark">
    <tr >
      <th class="text-yellow" scope="col">ID</th>
      <th class="text-yellow" scope="col">NAME</th>
      <th class="text-yellow d-none d-md-block" scope="col">EMAIl</th>
      <th class="text-yellow" scope="col">BALANCE</th>
    </tr>
  </thead>
  <tbody>
    <?php
while($result = mysqli_fetch_array($query)) {
    ?>
    <tr onclick="window.location='transfermoney.php?id=<?php echo $result['id']?>'">
      <th scope="row"><?php echo $result['id']?></th>
      <td><?php echo $result['name']?></td>
      <td class="d-none d-md-block"><?php echo $result['email']?></td>
